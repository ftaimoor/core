...
public class ResponseState {
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        if (isStateAwareResponse) {
            /*
             * Portlet Spec 2.0 requires Portlet Container to supply a "no-op" OutputStream object so delegate back
             * to current PortletServletResponseWrapper to return that one
             */
            return null;
        }
